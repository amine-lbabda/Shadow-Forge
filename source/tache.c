...
if (mode_collisionsouris(s->pos_key) == 1) {
s->btn_select = 2;
...
if (mode_collisionsouris(s->pos_rika) == 1) {
s->btn_select = 3;
...
if (mode_collisionsouris(s->pos_rikam) == 1) {
s->btn_select = 4;
...
if (mode_collisionsouris(s->pos_confirm) == 1) {
s->btn_select = 6;
...
if (mode_collisionsouris(s->pos_zone) == 1) {
s->btn_select = 7;
