...
void init_quiz(quiz *q, int t[], int *n)
{
    ...
    q->Return[1] = TTF_RenderText_Solid(font, "Return", red);
    if (!q->Return[0])
    {
        puts("erreur Return");
    }
...
void afficher_quiz(quiz q, SDL_Surface *ecran, unsigned int nb, int *animation)
{
    ...
    cursor(q.poscadre2[0]) ? SDL_BlitSurface(q.cadre2[1], NULL, ecran, &q.poscadre2[0])
                           : SDL_BlitSurface(q.cadre2[0], NULL, ecran, &q.poscadre2[0]);
    cursor(q.poscadre2[1]) ? SDL_BlitSurface(q.cadre2[1], NULL, ecran, &q.poscadre2[1])
                           : SDL_BlitSurface(q.cadre2[0], NULL, ecran, &q.poscadre2[1]);
    cursor(q.poscadre2[2]) ? SDL_BlitSurface(q.cadre2[1], NULL, ecran, &q.poscadre2[2])
                           : SDL_BlitSurface(q.cadre2[0], NULL, ecran, &q.poscadre2[2]);
    cursor(q.poscadre2[3]) ? SDL_BlitSurface(q.cadre2[1], NULL, ecran, &q.poscadre2[3])
                           : SDL_BlitSurface(q.cadre2[0], NULL, ecran, &q.poscadre2[3]);
    ...
    {
    case 0:
        SDL_BlitSurface(q.clock_pic[0], NULL, ecran, &q.posclock);
        break;
    case 1:
        SDL_BlitSurface(q.clock_pic[1], NULL, ecran, &q.posclock);
        break;
    case 2:
        SDL_BlitSurface(q.clock_pic[2], NULL, ecran, &q.posclock);
        break;
    case 3:
        SDL_BlitSurface(q.clock_pic[3], NULL, ecran, &q.posclock);
        break;
    case 4:
        SDL_BlitSurface(q.clock_pic[4], NULL, ecran, &q.posclock);
        break;
    case 5:
        SDL_BlitSurface(q.clock_pic[5], NULL, ecran, &q.posclock);
        break;
    case 6:
        SDL_BlitSurface(q.clock_pic[6], NULL, ecran, &q.posclock);
        break;
    case 7:
        SDL_BlitSurface(q.clock_pic[7], NULL, ecran, &q.posclock);
        break;
    case 8:
        SDL_BlitSurface(q.clock_pic[8], NULL, ecran, &q.posclock);
        break;
    }
}
